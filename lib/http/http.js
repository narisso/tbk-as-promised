...
HttpClient.prototype.setRequestCallback = function(func) {
  this.requestInfoCallback = func;
}
...
HttpClient.prototype.request = function(rurl, data, callback, exheaders, exoptions) {
  ...
  var req = self._request(options, function(err, res, body) {
    if(self.requestInfoCallback && self.requestInfoCallback instanceof Function) {
      self.requestInfoCallback(res);
    }
